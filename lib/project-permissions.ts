...
export const PROJECT_PERMISSIONS = {
  ...
  MANAGE_STAKEHOLDERS: ["AI_ANALYST", "AI_TEAM_LEAD"],
  MANAGE_DEPENDENCIES: ["AI_ANALYST", "DEVELOPER", "BUSINESS_OWNER", "AI_TEAM_LEAD"],
  VIEW_AGENT_INSIGHTS: ["AI_ANALYST", "DEVELOPER", "BUSINESS_OWNER", "AI_TEAM_LEAD", "MANAGEMENT"],
