...
export const metadata: Metadata = {
  title: "Sign in",
  description: "Sign in to Anwar Group TalentFlow.",
};
  ...
  return (
    <div className="w-full max-w-[420px]">
      ...
      <p className="mt-2xs mb-xl max-w-[52ch] text-body text-muted">
        Use your Anwar Group work email. If you don’t have an account yet, your
        TA administrator creates one for you.
      </p>

      <LoginForm />

      <p className="mt-xl border-t border-border pt-md text-body-sm text-muted">
        Trouble signing in? Contact your TA administrator or{" "}
