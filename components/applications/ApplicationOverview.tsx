...
/**
 * The Pipeline view of one application: where it is, how to move it, and the
 * permanent record of every move so far.
 *
 ...
 * rendered first, above the fold, before history or controls, and
 * `ApplicationSummary` types all of them as required so none can go missing.
 *
 * Extracted from `ApplicationPanel` when the screening, interview and message
 * sections landed: the panel is now the tab container, and this is one tab.
 */
