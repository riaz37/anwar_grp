 ...
 *
 * Every `rgba(63, 61, 158, …)` below is one blurred light source at a
 * different alpha — that is `--primary-med` (#3f3d9e), the single brand
 * pigment (ink indigo), expressed at opacities no token names. There is no
 ...
 * `aria-hidden`, and the whole rig is dimmed hard in light mode, where an
 * indigo wash over white would eat the 4.5:1 the body copy needs
 * (DESIGN.md §9).
 */
  ...
  return (
    ...
    >
      <div className="glow-parallax absolute top-[-380px] right-[-260px] h-[1000px] w-[760px] will-change-transform">
        <div className="absolute inset-0 rounded-full bg-[rgba(63,61,158,0.2)] blur-[180px]" />
        ...
        <div
          ...
          style={{
            ...
            WebkitMaskImage:
              "radial-gradient(circle at 82% 18%, rgba(0,0,0,0.95) 22%, transparent 62%)",
            backgroundImage:
              "conic-gradient(from -28deg at 74% 2%, rgba(63,61,158,0.5) 0deg, rgba(63,61,158,0.28) 18deg, transparent 56deg, transparent 360deg)",
          }}
        />
        ...
        <div
          ...
          style={{
            backgroundImage:
              "conic-gradient(from -62deg at 90% 10%, rgba(63,61,158,0.3) 0deg, rgba(63,61,158,0.1) 22deg, transparent 72deg)",
            filter: "blur(30px)",
          }}
        />
        ...
        <div
          ...
          style={{
            mixBlendMode: "screen",
            backgroundImage:
              "repeating-linear-gradient(118deg, rgba(63,61,158,0.3) 0px, rgba(63,61,158,0.3) 12px, transparent 12px, transparent 44px)",
      ...
      <div className="absolute top-[240px] left-[-320px] h-[620px] w-[620px] rounded-full bg-[rgba(63,61,158,0.07)] blur-[170px]" />
    </div>
  );
}
